...
var localization = {
    en: {
        title: "Score a dataset using a Survival Model (All variables mus",
        navigation: "Survival (Standard)",
...
module.exports.item = new scoringSurvivalML().render()