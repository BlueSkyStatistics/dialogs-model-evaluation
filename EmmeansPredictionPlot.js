...
class EmmeansPredictionPlot extends baseModal {
    static dialogId = 'EmmeansPredictionPlot'
    static t = baseModal.makeT(EmmeansPredictionPlot.dialogId)

    constructor() {
        var config = {
            id: EmmeansPredictionPlot.dialogId,
            label: EmmeansPredictionPlot.t('title'),
            modalType: "two",
...
`
        ...
        var objects = {
            ...
            labelModelSel: {
                el: new labelVar(config, {
                    label: EmmeansPredictionPlot.t('labelModelSel'),
                    h: 5,
                    style: "mt-1 mb-1",
                })
            },
            modelSelection: {
                el: new selectVar(config, {
                    no: "modelSelection",
                    label: EmmeansPredictionPlot.t('modelSelection'),
                    multiple: false,
            ...
            labelNumericVars: {
                el: new labelVar(config, {
                    label: EmmeansPredictionPlot.t('labelNumericVars'),
                    h: 5,
                    style: "mb-1",
                })
            },
            ...
            numVar1: {
                el: new dstVariable(config, {
                    label: EmmeansPredictionPlot.t('numVar1'),
                    no: "numVar1",
                    required: true,
            ...
            atSpec1: {
                el: new input(config, {
                    no: "atSpec1",
                    label: EmmeansPredictionPlot.t('atSpecLabel'),
                    required: false,
                    allow_spaces: true,
                    type: "character",
            ...
            numVar2: {
                el: new dstVariable(config, {
                    label: EmmeansPredictionPlot.t('numVar2'),
                    no: "numVar2",
                    required: false,
                    filter: "Numeric|Scale",
                    extraction: "NoPrefix",
            ...
            numVar3: {
                el: new dstVariable(config, {
                    label: EmmeansPredictionPlot.t('numVar3'),
                    no: "numVar3",
                    required: false,
                    filter: "Numeric|Scale",
                    extraction: "NoPrefix",
            ...
            numVar4: {
                el: new dstVariable(config, {
                    label: EmmeansPredictionPlot.t('numVar4'),
                    no: "numVar4",
                    required: false,
                    filter: "Numeric|Scale",
                    extraction: "NoPrefix",
            ...
            numVar5: {
                el: new dstVariable(config, {
                    label: EmmeansPredictionPlot.t('numVar5'),
                    no: "numVar5",
                    required: false,
                    filter: "Numeric|Scale",
                    extraction: "NoPrefix",
            ...
            labelGroupVar: {
                el: new labelVar(config, {
                    label: EmmeansPredictionPlot.t('labelGroupVar'),
                    h: 5,
                    style: "mt-2 mb-1",
                })
            },
            groupVar: {
                el: new dstVariableList(config, {
                    label: EmmeansPredictionPlot.t('groupVar'),
                    no: "groupVar",
                    required: true,
			...
			showModelEquationChk: {
                el: new checkbox(config, {
                    label: EmmeansPredictionPlot.t('showModelEquationChk'), 
			...
			showEMMTableChk: {
                el: new checkbox(config, {
                    label: EmmeansPredictionPlot.t('showEMMTableChk'),
					no: "showEMMTableChk",
                    bs_type: "valuebox",
                    extraction: "BooleanValue",
                    true_value: "TRUE",
            ...
            labelOptions: {
                el: new labelVar(config, {
                    label: EmmeansPredictionPlot.t('labelOptions'),
                    h: 5,
                    style: "mt-4 mb-1",
                })
            },
            confLevel: {
                el: new inputSpinner(config, {
                    no: "confLevel",
                    label: EmmeansPredictionPlot.t('confLevel'),
                    min: 0.5,
                    max: 0.999,
                    step: 0.01,
                    value: 0.95,
            ...
            showCI: {
                el: new checkbox(config, {
                    no: "showCI",
                    label: EmmeansPredictionPlot.t('showCI'),
                    value: true,
                    extraction: "NoPrefix|UseComma",
                    style: "mb-3",
                })
            ...
            plotTitle: {
                el: new input(config, {
                    no: "plotTitle",
                    label: EmmeansPredictionPlot.t('plotTitle'),
                    required: false,
                    allow_spaces: true,
                    type: "character",
            ...
            xAxisLabel: {
                el: new input(config, {
                    no: "xAxisLabel",
                    label: EmmeansPredictionPlot.t('xAxisLabel'),
                    required: false,
                    allow_spaces: true,
                    type: "character",
                    extraction: "TextAsIs",
            ...
            yAxisLabel: {
                el: new input(config, {
                    no: "yAxisLabel",
                    label: EmmeansPredictionPlot.t('yAxisLabel'),
                    required: false,
                    allow_spaces: true,
                    type: "character",
                    extraction: "TextAsIs",
        ...
        const content = {
            ...
            nav: {
                name: EmmeansPredictionPlot.t('navigation'),
                 icon: "icon-y-hat",
        ...
        this.help = {
            title: EmmeansPredictionPlot.t('help.title'),
            r_help: EmmeansPredictionPlot.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: EmmeansPredictionPlot.t('help.body')
        }
;
    }
}
...
module.exports = {
    render: () => new EmmeansPredictionPlot().render()
}
