...
var localization = {
    en: {
        ...
        navigation: "Convert N Models (RSM to LM)",
        modelselector1: "Select one or more models to inspect and convert from RSM terms (e.g., FO, TWI, SO, PQ), if any, in model formula to equivalent LM terms",
