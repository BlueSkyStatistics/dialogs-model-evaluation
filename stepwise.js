...
var localization = {
    en: {
        ...
        label2: "Linear model (lm), Generalized linear model (glm), Ordered Logistic/Probit regression (polr), Feed-Forward Neural Networks, CoxPH models and Multinomial Log-Linear Models (nnet)",
