...
var localization = {
    en: {
        ...
        zeroCheck: "Also compare observed vs. model-predicted zero rates (applies only to Poisson / Negative Binomial / Zero-Inflated / Hurdle count models among those selected; other model types are skipped)",
        vuongCheck: "Run a Vuong test comparing exactly two count models (e.g. Negative Binomial vs. Zero-Inflated/Hurdle) - requires exactly 2 models selected, both Poisson / Negative Binomial / Zero-Inflated / Hurdle",
        help: {
            title: "Summarize N Models",
        ...
        var objects = {
            ...
            zeroCheck: {
                el: new checkbox(config, {
                    label: localization.en.zeroCheck,
                    no: "zeroCheck",
                    style: "mt-3",
                    bs_type: "valuebox",
            ...
            vuongCheck: {
                el: new checkbox(config, {
                    label: localization.en.vuongCheck,
                    no: "vuongCheck",
                    style: "mt-3",
                    bs_type: "valuebox",
                    extraction: "BooleanValue",
